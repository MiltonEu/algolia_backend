...
public class IndexablePokemon extends AbstractIndexableObject {
    private Long id;
    private String name;
    private int life;
    private int damage;
    ...
    public IndexablePokemon(String objectID,Long id, String name, int life, int damage, String picture, Set<PokemonType> types, UserResponseDTO owner) {
        super(objectID);
        this.id = id;
        this.name = name;
        this.life = life;
